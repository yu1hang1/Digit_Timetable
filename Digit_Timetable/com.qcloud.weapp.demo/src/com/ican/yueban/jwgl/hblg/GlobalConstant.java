package com.ican.yueban.jwgl.hblg;
...
public class GlobalConstant {
	...
	public static final String INDEX_URL = "http://60.2.249.144/";// 天津工业大学教务系统首页
	public static final String SECRETCODE_URL = "http://60.2.249.144/validateCodeAction.do?random=0.9933747059206561";// 验证码页面
	public static final String LOGIN_URL = "http://60.2.249.144/loginAction.do";// 教务系统登录页
	public static final String MAIN_URL = "http://60.2.249.144/menu/top.jsp";// 济大教务系统主页，菜单页面
	public static final String QUERY_CLASSROOM_URL = "http://60.2.249.144/xxjsjy.aspx?xh=";// 济大查询空教室链接
