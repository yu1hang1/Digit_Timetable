...
public class Jwgl_hblg {
	...
	public List<Object[]> queryStuCourse(String xnd, String xqd)
		...
		String newQueryStuCourseUrl = "http://60.2.249.144/xkAction.do?actionType=6";
	   ...
	   // List<Object[]>  list3 = new ArrayList<Object[]> ();//定义一个list对象
		...
		for (int i = 116; i < eleCourse.size(); i++) {
		...
		{ 
			...
			for(int s=0;s<k;s++)
			{
				...
				ob[8]=3*e+"rem";
				ob[9]="周"+ob[0]+"第"+listSub1.get(12+s*7)+"-"+Day[a+e-1]+"节";
				if(ob[0]!=null){
				list.add(ob);
				}
			}
	...
	public static void main(String[] args) {
		...
		try {
			...
			jw.login("201614290328", "201614290328",secret);
