...
public interface GlobalConstant {
	...
	public static final String SECRETCODE_URL = "http://my.lnnu.edu.cn/cas/security/initDigitPicture.do?";// 验证码页面
	public static final String LOGIN_URL = "http://my.lnnu.edu.cn/cas/login;jsessionid=EA52C6099E9EE6DB92087FF97990577C?service=http://210.47.223.8";// 济大教务系统登录页
	public static final String MAIN_URL = "http://210.47.223.8/ACTIONQUERYSTUDENTSCHEDULEBYSELF.APPPROCESS";// 济大教务系统主页，菜单页面
