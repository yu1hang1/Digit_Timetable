...
public interface GlobalConstant {
	...
	public static final String INDEX_URL = "http://211.87.155.20/(l0tctd55rrbdk2452nvp2f55)/default2.aspx";// 济大教务系统首页
	public static final String SECRETCODE_URL = "http://211.87.155.20/(l0tctd55rrbdk2452nvp2f55)/CheckCode.aspx";// 验证码页面
	public static final String LOGIN_URL = "http://211.87.155.20/(l0tctd55rrbdk2452nvp2f55)/default2.aspx";// 济大教务系统登录页
	public static final String MAIN_URL = "http://211.87.155.20/(l0tctd55rrbdk2452nvp2f55)/xs_main.aspx?xh=";// 济大教务系统主页，菜单页面
