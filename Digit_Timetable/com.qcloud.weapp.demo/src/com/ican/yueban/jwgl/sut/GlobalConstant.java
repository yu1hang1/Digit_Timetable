package com.ican.yueban.jwgl.sut;
...
public interface GlobalConstant {
	...
	public static final String SECRETCODE_URL = "http://jwc.sut.edu.cn/ACTIONVALIDATERANDOMPICTURE.APPPROCESS";// 验证码页面
	public static final String LOGIN_URL = "http://jwc.sut.edu.cn/ACTIONLOGON.APPPROCESS?mode=4";// 济大教务系统登录页
	public static final String MAIN_URL = "http://jwc.sut.edu.cn/ACTIONLOGON.APPPROCESS?mode=4";// 济大教务系统主页，菜单页面
