...
public class Jwgl_sut {
	...
	public String login(String stuNumber, String password,String secret)
		...
		nameValuePairLogin
				.add(new BasicNameValuePair("WebUserNO", stuNumber));// 隐藏表单值
		nameValuePairLogin
		...
		//	for (int i = 2; i < eleCourse.size(); i++) {
			...
			System.out.println("登录成功！欢迎您：" +eleCourse.get(2).text());
			//client.close();
			return "欢迎您："+eleCourse.get(2).text();
		} else {
	...
	public static void main(String[] args) {
		...
		try {
			...
			jw.login("150200206", "281516",secret);
