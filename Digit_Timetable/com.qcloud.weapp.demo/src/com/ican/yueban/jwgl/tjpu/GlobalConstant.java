...
public interface GlobalConstant {
	...
	public static final String INDEX_URL = "http://jwpt.tjpu.edu.cn/";// 天津工业大学教务系统首页
	public static final String SECRETCODE_URL = "http://jwpt.tjpu.edu.cn/validateCodeAction.do?random=0.07494944775380175";// 验证码页面
	public static final String LOGIN_URL = "http://jwpt.tjpu.edu.cn/loginAction.do";// 教务系统登录页
	public static final String MAIN_URL = "http://jwpt.tjpu.edu.cn/menu/top.jsp";// 济大教务系统主页，菜单页面
